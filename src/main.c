...
int main(void)
{
    ...
    // flash_program_block(0x08000000u,
    //                     flash_image,
    //                     sizeof(flash_image) / sizeof(flash_image[0]));
    ...
    // Попытка изменить
    // flash_unlock_target();
    // flash_erase_page(0x08000000u);
    
    // flash_erase_page(0x08000400u);
    // if (!flash_program_word32(0x08000000u, 0x20002800)) {
    //     // return 0;
    // }
    // flash_lock_target();

    // flash_unlock_target();
    // if (!flash_program_word32(0x08000000u+4u, 0x08000139)) {
    //     // return 0;
    // }
    // flash_lock_target();

    // flash_unlock_target();
    // if (!flash_program_word32(0x08000000u+8u, 0x08000135)) {
    //     // return 0;
    // }
    // flash_lock_target();
    // while (1) {
